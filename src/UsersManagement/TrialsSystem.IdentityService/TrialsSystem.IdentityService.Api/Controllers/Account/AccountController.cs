...
namespace TrialsSystem.IdentityService.Api.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [Route("Register")]
        public async Task<IActionResult> Register(RegisterInputViewModel model, string button)
        {
            if (ModelState.IsValid)
            {
            ...
            var vm = await BuildRegisterViewModelAsync(model.ReturnUrl,
                _mapper.Map<RegisterViewModel>(model));
        ...
        [Route("BuildRegisterViewModelAsync")]
        private async Task<RegisterViewModel> BuildRegisterViewModelAsync(string returnUrl, RegisterViewModel model = null)
        {
            if (model == null)
            {
            ...
            model.Genders = new List<SelectListItem>
            {
                new()
                {
                    Value = "86D01F4C-A514-4858-AC44-21E56E2D7E0C",
                    Text = "Female"

                },
                new()
                {
                    Value = "C7166A6D-3AAA-4B99-A9D3-9A5294A78CFC",
                    Text = "Male"
